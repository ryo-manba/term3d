...
static double	addition_theorem_x(const double vector2_x, const double vector2_y, const double additional_radian);
static double	addition_theorem_y(const double vector2_x, const double vector2_y, const double additional_radian);
...
void	move(double *horizontal, double *vertical, const double additional_radian)
{
	...
	// 加法定理適用
	*horizontal = addition_theorem_y(*horizontal, *vertical, additional_radian);
	*vertical = addition_theorem_x(*horizontal, *vertical, additional_radian);
