...
static double	addition_theorem_sin(const double vector2_x, const double vector2_y, const double additional_radian);
static double	addition_theorem_cos(const double vector2_x, const double vector2_y, const double additional_radian);
